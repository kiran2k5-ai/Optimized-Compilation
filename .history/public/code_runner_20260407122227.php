...
if (!file_exists($questionsFile)) {
    $defaultQuestions = [
        'q1' => [
            ...
            'description' => 'Solve the N-Queens problem. Input: number of queens (n). Output: number of solutions for n-queens problem.',
            'language' => 'python',
            'marks' => 10,
            'tests' => [
                ['input' => '4', 'expected' => '2'],
        ...
        'q2' => [
            ...
            'description' => 'Solve nth Fibonacci number using dynamic programming. Input: n. Output: fibonacci(n).',
            'language' => 'python',
            'marks' => 10,
            'tests' => [
                ['input' => '5', 'expected' => '5'],
        ...
        'q3' => [
            ...
            'description' => 'Calculate height of binary tree. Input: preorder traversal. Output: height of tree.',
            'language' => 'python',
            'marks' => 10,
            'tests' => [
