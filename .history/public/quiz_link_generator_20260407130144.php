        ...
        <textarea id="questionsJson" placeholder='Paste your questions JSON here. Example:
{
  "q1": {
    ...
    "tests": [
      {"input": "4", "expected": "2"}
        ...
        <div class="example">
            <strong>Example JSON (with Hidden Test Cases):</strong>
            <pre>{
  "q1": {
  ...
  "q2": {
    ...
    "tests": [
      {"input": "5", "expected": "5"},
      {"input": "7", "expected": "13", "hidden": true}
    ]
  },
  "q3": {
    ...
    "tests": [
      ...
      {"input": "5", "expected": "0", "hidden": true}
            ...
            <p><strong style="color: #dc3545;">✨ NEW FEATURES:</strong></p>
            <ul>
              <li><code>"hidden": true</code> = Hidden test case (not shown to student, but runs for scoring)</li>
              <li>Student answers are auto-saved to browser (if they refresh, code is restored)</li>
              <li>When students move to next/previous question, their code is preserved</li>
              <li>Student ID is NOT collected</li>
              <li>Submission confirmation only shows: "Quiz Submitted Successfully"</li>
            </ul>
        </div>
    </div>
