...
// Create jobe_api class as a proxy to jobe_api_mock for mock server compatibility
if (!class_exists('jobe_api')) {
    class jobe_api {
        public static function __callStatic($method, $args) {
            if (class_exists('jobe_api_mock')) {
                return call_user_func_array(['jobe_api_mock', $method], $args);
            }
            throw new Exception("jobe_api_mock class not found");
        }
    }
}
