...
class qtype_coderunner_renderer extends qtype_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) {
        ...
        // Load Pyodide Sandbox for local code execution
        $this->page->requires->js(new moodle_url('/question/type/coderunner/pyodide_sandbox.js'));
        // Add Bootstrap icons if needed for buttons
        $this->page->requires->css(new moodle_url('/lib/fontawesome/css/all.min.css'));
