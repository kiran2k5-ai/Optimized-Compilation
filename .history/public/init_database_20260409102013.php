...
if ($result->num_rows == 0) {
    $mysqli->query("INSERT INTO mdl_course (
        ...
        format, startdate, enddate, visible, visibleold, newsitems, showgrades, 
        showreports, maxbytes, legacyfiles, showactivitydates, showcompletiondates, 
        lang, enablecomment
    ) VALUES (
        0, 1, 'Front page', 'frontpage', '', '', 1, 'site', 0, 0, 1, 1, 3, 0, 0, 
        2097152, 0, 1, 1, '', 0
    )");
